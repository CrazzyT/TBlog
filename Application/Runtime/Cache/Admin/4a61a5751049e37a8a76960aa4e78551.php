...
<body>
<a class="layui-btn layui-btn-normal" href="<?php echo U('Login/add');?>">用户添加</a>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
            ...
            <td>
                <div class="layui-btn-group">
                    ...
                    <a class="layui-btn layui-btn-small" href="<?php echo U('Login/del');?>?id=<?php echo ($v["user_id"]); ?>"><i class="layui-icon"></i></a>
                </div>
            </td>
