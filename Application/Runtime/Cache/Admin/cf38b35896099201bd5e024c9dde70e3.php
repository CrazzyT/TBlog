                ...
                <div class="layui-form-item" style="margin:0;margin-top:15px;">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="type_name" id="type_id">
                                <option value="0">请选择分类</option>
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v["type_id"]); ?>"><?php echo ($v["type_name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" placeholder="截止日" id="etime" name="etime" type="text">
                        </div>
                        <div class="layui-input-inline" style="width:auto">
                            <button class="layui-btn search" type="button" lay-submit lay-filter="formSearch">搜索</button>
                        </div>
                    </div>
                    <div class="layui-inline">
                        <div class="layui-input-inline" style="width:auto">
                            <a  href="<?php echo U('Title/add');?>" id="addArticle" class="layui-btn layui-btn-normal">发表文章</a>
                        </div>
                    </div>
                </div>
            </form>
