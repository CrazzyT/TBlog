...
<head>
    ...
    <title>不落阁 - 一个PHP程序员的个人博客网站</title>
        ...
        <div class="blog-container">
            ...
            <ul class="layui-nav" lay-filter="nav">
                ...
                <li class="layui-nav-item">
                    <a href="<?php echo U('Index/article');?>"><i class="fa fa-file-text fa-fw"></i>&nbsp;文章专栏</a>
                </li>
                <li class="layui-nav-item">
                    <a href="<?php echo U('Index/resource');?>"><i class="fa fa-tags fa-fw"></i>&nbsp;资源分享</a>
                </li>
                <li class="layui-nav-item">
                    <a href="<?php echo U('Index/timeline');?>"><i class="fa fa-hourglass-half fa-fw"></i>&nbsp;点点滴滴</a>
                </li>
                <li class="layui-nav-item">
                    <a href="<?php echo U('Index/about');?>"><i class="fa fa-info fa-fw"></i>&nbsp;关于本站</a>
                </li>
            </ul>
            <!-- 手机和平板的导航开关 -->
        ...
        <div class="blog-main">
            <div class="blog-main-left">
                ...
                <div class="article shadow">
                    <div class="article-left">
                        <img src="/Public/Home/images/cover/201703181909057125.jpg" alt="基于laypage的layui扩展模块（pagesize.js）！" />
                    </div>
            ...
            <div class="blog-main-right">
                ...
                <div class="article-category shadow">
                    ...
                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><a href="" value="<?php echo ($v["type_id"]); ?>"><?php echo ($v["type_name"]); ?>123</a><?php endforeach; endif; ?>
                    <div class="clear"></div>
                </div>
