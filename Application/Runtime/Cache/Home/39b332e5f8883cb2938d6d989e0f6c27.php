        ...
        <div class="blog-main">
            ...
            <div class="home-tips shadow">
                ...
                <div class="home-tips-container">
                    <span style="color: #009688">偷偷告诉大家，隔壁老王出售冒蓝光的加特林！</span>
                    ...
                    <span style="color: #009688">哒哒哒 &nbsp;—— &nbsp;一个PHP程序员的个人博客，新版网站采用Layui为前端框架，目前正在建设中！</span>
                </div>
            </div>
            <!--左边文章列表-->
                ...
                <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="article shadow">
                    ...
                    <div class="article-right">
                        <div class="article-title">
                            ...
                            <input type="hidden" value="<?php echo ($v["title_id"]); ?>">
                        </div>
                        <div class="article-abstract"><?php echo ($v["title_motto"]); ?></div>
                    </div>
                    <div class="clear"></div>
                    <div class="article-footer">
                        ...
                        <span><i class="fa fa-tag"></i>&nbsp;&nbsp;<a href="#" value="<?php echo ($v["type_id"]); ?>"><?php echo ($v["type_name"]); ?></a></span>
            ...
            <div class="blog-main-right">
                <div class="blogerinfo shadow">
                    ...
                    <p class="blogerinfo-nickname">Crazy Mr.T</p>
